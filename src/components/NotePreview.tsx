    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Overlay className="fixed rounded-xl inset-0 bg-stone-500/40 dark:bg-stone-900/90" />
        </Transition.Child>
        ...
        >
          <Dialog.Panel className="bg-white dark:bg-stone-800 rounded-lg w-full max-w-screen-md min-h-full p-8 pt-10 shadow-2xl shadow-stone-400/70 dark:shadow-stone-900/70 mx-auto">
            <article className="prose prose-stone dark:prose-invert prose-headings:font-medium">
